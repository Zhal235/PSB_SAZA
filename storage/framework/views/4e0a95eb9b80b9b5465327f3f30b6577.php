...
<body class="bg-gray-100">
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-indigo-600 text-white p-6">
            ...
            <nav class="space-y-2">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-2 rounded bg-indigo-700 hover:bg-indigo-800 transition">
                    📊 Dashboard
                </a>
                ...
                <a href="<?php echo e(route('admin.pembayaran-items.index')); ?>" class="block px-4 py-2 rounded hover:bg-indigo-700 transition">
                    💳 Item Pembayaran
                </a>
                <a href="<?php echo e(route('admin.pembayaran.index')); ?>" class="block px-4 py-2 rounded hover:bg-indigo-700 transition">
                    💰 Kelola Pembayaran
                </a>
...
<?php /**PATH C:\Users\Rhezal Maulana\Documents\GitHub\PSB_SAZA\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>