...
<head>
    ...
    <title>Upload Dokumen - PSB SAZA</title>
        ...
        <div class="flex-1 overflow-auto">
            ...
            <div class="bg-white shadow p-6 flex justify-between items-center sticky top-0 z-10">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Santri: <span class="font-bold text-indigo-600"><?php echo e($calonSantri->nama); ?></span></p>
                </div>
                <a href="<?php echo e(route('admin.calon-santri.index')); ?>" class="text-gray-600 hover:text-gray-800 font-semibold">← Kembali</a>
            </div>
                ...
                <div class="bg-white rounded-lg shadow max-w-4xl">
                    <div class="p-8">
                            ...
                            <?php $__currentLoopData = $dokumenTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="border border-gray-300 rounded-lg p-4">
                                    ...
                                    <?php if($dokumen): ?>
                                        ...
                                        <button type="button" class="w-full bg-yellow-500 text-white px-3 py-2 rounded hover:bg-yellow-600 font-semibold transition text-sm" onclick="showUploadMenu('ulang-<?php echo e($loop->index); ?>', '<?php echo e($value); ?>')">
                                            🔄 Upload Ulang
                                        </button>
                                    <?php else: ?>
                                        <!-- Upload Form - Hidden -->
                                        ...
                                        <!-- Upload Button -->
                                        <button type="button" class="w-full bg-indigo-600 text-white px-3 py-2 rounded hover:bg-indigo-700 font-semibold transition text-sm" onclick="showUploadMenu('<?php echo e($loop->index); ?>', '<?php echo e($value); ?>')">
                        ...
                        <div class="flex gap-4 pt-6 border-t mt-6">
                            <a href="<?php echo e(route('admin.calon-santri.index')); ?>" class="bg-gray-400 text-white px-6 py-2 rounded hover:bg-gray-500 font-semibold transition">✅ Selesai</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\Rhezal Maulana\Documents\GitHub\PSB_SAZA\resources\views/admin/dokumen/create.blade.php ENDPATH**/ ?>