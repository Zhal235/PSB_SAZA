        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y">
                    @foreach($pembayaran->calonSantri->pembayaran->items as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-right text-red-600">
                                Rp {{ number_format($pembayaran->remaining_amount / count($pembayaran->calonSantri->pembayaran->items ?? 1) ?? 0, 0, ',', '.') }}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
