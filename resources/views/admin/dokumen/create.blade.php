        ...
        <div class="flex-1 overflow-auto">
            ...
            <div class="bg-white shadow p-6 flex justify-between items-center sticky top-0 z-10">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Santri: <span class="font-bold text-indigo-600">{{ $calonSantri->nama }}</span></p>
                </div>
                <a href="{{ route('admin.calon-santri.index') }}" class="text-gray-600 hover:text-gray-800 font-semibold">← Kembali</a>
            </div>
                ...
                <div class="bg-white rounded-lg shadow max-w-4xl">
                    <div class="p-8">
                        ...
                        <div class="flex gap-4 pt-6 border-t mt-6">
                            <a href="{{ route('admin.calon-santri.index') }}" class="bg-gray-400 text-white px-6 py-2 rounded hover:bg-gray-500 font-semibold transition">✅ Selesai</a>
                        </div>
                    </div>
                </div>
            </div>
