...
@section('page-title', 'Edit Calon Santri: ' . $calonSantri->nama)
@section('page-subtitle', 'Jenjang: ' . $calonSantri->jenjang)
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-4 gap-4 mt-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="asal_sekolah" value="{{ old('asal_sekolah', $calonSantri->asal_sekolah) }}" class="w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="{{ $calonSantri->jenjang === 'MTs' ? 'SD/MI ...' : 'SMP/MTs ...' }}" />
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-4 gap-4 mt-4">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" name="no_telp" value="{{ old('no_telp', $calonSantri->no_telp) }}" class="w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="08xxxxxxxxxx" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            @if($calonSantri->user)
                                <div class="bg-green-50 border-l-4 border-green-500 text-green-700 p-3 mb-4 text-sm">
                                    ✅ Akun sudah terkait dengan: <strong>{{ $calonSantri->phone_type === 'ayah' ? 'HP Ayah' : 'HP Ibu' }} ({{ $calonSantri->user->phone }})</strong>
                                </div>
                            @endif
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        <label class="flex items-center">
                                            <input type="radio" name="phone_type" value="ayah" class="mr-3" {{ old('phone_type', $calonSantri->phone_type) === 'ayah' ? 'checked' : '' }} />
                                            <span class="text-sm">📱 Nomor HP Ayah</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="radio" name="phone_type" value="ibu" class="mr-3" {{ old('phone_type', $calonSantri->phone_type) === 'ibu' ? 'checked' : '' }} />
                                            <span class="text-sm">📱 Nomor HP Ibu</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="radio" name="phone_type" value="" class="mr-3" {{ old('phone_type', $calonSantri->phone_type) === null || old('phone_type', $calonSantri->phone_type) === '' ? 'checked' : '' }} />
