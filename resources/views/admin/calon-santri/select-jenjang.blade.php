...
<body class="bg-gradient-to-br from-indigo-100 to-purple-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-lg shadow-2xl p-8">
            ...
            <div class="space-y-4">
                <!-- MTs Button -->
                <a href="{{ route('admin.calon-santri.create', ['jenjang' => 'MTs']) }}" class="block">
                ...
                <!-- SMK Button -->
                <a href="{{ route('admin.calon-santri.create', ['jenjang' => 'SMK']) }}" class="block">
            ...
            <div class="text-center mt-6">
                <a href="{{ route('admin.calon-santri.index') }}" class="text-indigo-600 hover:text-indigo-700 text-sm font-medium">
                    ← Kembali ke List
                </a>
            </div>
        </div>
